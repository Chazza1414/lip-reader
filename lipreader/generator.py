...
from common.constants import IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_CHANNELS, DATASET_PATH, VIDEO_FRAME_NUM, NUM_PHONEMES
from videos import Video
from align import Align
from helpers import get_list_safe
            ...
            try:
                if os.path.isfile(video_path):
                    ...
                    if K.image_data_format() == 'channels_first' and video.frames.shape != (self.img_c,VIDEO_FRAME_NUM,self.img_w,self.img_h):
                        print("Video "+video_path+" has incorrect shape "+str(video.frames.shape)+", must be "+str((self.img_c,VIDEO_FRAME_NUM,self.img_w,self.img_h))+"")
                        continue
                    if K.image_data_format() != 'channels_first' and video.frames.shape != (VIDEO_FRAME_NUM,self.img_w,self.img_h,self.img_c):
                        print("Video "+video_path+" has incorrect shape "+str(video.frames.shape)+", must be "+str((VIDEO_FRAME_NUM,self.img_w,self.img_h,self.img_c))+"")
                        continue
                else:
